...
Please note that this version works with Flink 1.10.1 with Scala 2.11 support, which can be downloaded [here](https://archive.apache.org/dist/flink/flink-1.10.1/flink-1.10.1-bin-scala_2.11.tgz).
...
usually found in the `bin` directory of the Flink installation. E.g. `/home/myuser/flink-1.10.1/bin/flink`.
